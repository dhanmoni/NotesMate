...
import {addName, addChapter, deleteChapter, addnotesinChapter, addpdfinChapter, deletepdfinChapter, deletenotesinChapter, editChapter, setAdTimeForEditChapter} from '../redux/action/mainAction'
...
class ChapterScreen extends Component {
    static navigationOptions = {
      ...
      componentDidMount(){
        this.setState({chapter_name: this.props.auth.singleChapter.chapter_name,
      ...
      deletepdf(item) {
        ...
        Alert.alert(
            ...
            {text: 'Cancel', onPress: () =>{}},
            {text: 'Remove', onPress: () => this.props.deletepdfinChapter(item,this.state.subject_name, this.state.chapter_name)},
            ],
            { cancelable: true }
        )
        }
        ...
        deletenotes(item) {
          ...
          Alert.alert(
              ...
              {text: 'Remove', onPress: () => {
                ...
                this.props.deletenotesinChapter(this.state.selectedPhotoUri,this.state.subject_name, this.state.chapter_name)
              }},
              ],
              { cancelable: true }
          )
  ...
  render() {
    ...
    return (
      ...
      {/********************************MAIN BODY************************************* */}
          ...
          <View style={{flex:10, backgroundColor:'#fff'}}>
              ...
              </TouchableOpacity>
              {
                this.state.showDocument == true ? (
                  ...
                  <View>
                     {
                this.props.auth.singleChapter.notes.documents.length <= 0 ? (
                  <View>
                  ...
                  <View style={{margin:'auto',alignItems:'center', justifyContent:'center' }}>
                    <FlatList
                          data={this.props.auth.singleChapter.notes.documents}
        ...
        <Modal isVisible={this.state.isEditChapterModalVisible} 
        ...
        <View style={{backgroundColor:'#fff', width:WIDTH-50,alignSelf:'center',borderRadius:20, overflow:'hidden'}}>
              ...
              <TouchableOpacity style={{alignItems:"center",padding:5,width:30+'%', borderRadius:10, justifyContent:'center', backgroundColor:'#0073ff'}} onPress={()=> {
               this.props.editChapter(this.state.chapter_name, this.state.subject_name, this.state.prev_chapter_name)
                
                 this.setState({isEditChapterModalVisible:false})
                 let expirationDate = this.props.auth.editChapterAdExpiration;
                ...
                InterstitialAdManager.showAd('324550781538284_324677224858973')
...
export default connect(mapStateToProps,{addChapter,deleteChapter, addnotesinChapter, addpdfinChapter, deletenotesinChapter, deletepdfinChapter, editChapter, setAdTimeForEditChapter })(ChapterScreen)
