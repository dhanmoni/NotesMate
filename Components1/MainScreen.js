  ...
  _renderItem = (item, index) => {
    ...
    if (this.props.auth.darkTheme) {
      (bgColor = '#303030'), (textColor = '#fff'), (cardColor =
        '#424242'), (deleteColor = '#fff');
    } else {
      (bgColor = '#fff'), (textColor = '#000'), (cardColor =
        '#fff'), (deleteColor = '#f70000');
    }
  ...
  render() {
    ...
    return (
      <View style={{ flex: 1, backgroundColor: bgColor }}>
          ...
          <ScrollView>
              ...
              {this.props.auth.subjects.length <= 0
                ...
                >
                  ...
                  <TouchableOpacity
                    activeOpacity={0.8}
                    onPress={() =>
                      this.setState({ isSubjectModalVisible: true })}
                    style={{
                      marginTop: 10,
                      marginBottom: 10,
                      margin: 'auto',
            ...
            <TouchableOpacity
              ...
              onPress={() => {
                ...
                this.props.navigation.navigate('UnCatagorised');
              }}
              style={{
                marginTop: 20,
                paddingHorizontal: 20,
        ...
        <Modal
          isVisible={this.state.isSubjectModalVisible}
            ...
            >
              ...
              <TouchableOpacity
                ...
                onPress={() => {
                  ...
                  if (
                    isEmpty(this.state.subject_name)
                  ) {
                    ToastAndroid.show(
